...
function Customswich_component9({sendxtoparent,selectionmode, option1, option2, option3, option4, option5, option6, option7, option8, option9, option10, option11, option12, option13, option14, option15, option16, option17, option18, onselectswitch}) {
    ...
    return (
        ...
        <View>
            ...
            <Text style={{marginVertical:10, fontWeight: '900', color: '#D20062', verticalAlign: 'bottom', marginRight: 10 }}>مدیریت دروس</Text>
...
export default Customswich_component9;
