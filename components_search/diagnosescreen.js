    ...
    return (
        ...
        <View style={{ flex: 1, marginTop: 15 }}>
            ...
            <View style={{ marginTop: 10 }}>
                <Customswich_component4 selectionmode={1} onselectswitch={onselectswich} />
            ...
            {active == 1 ? (
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }} >
                    ...
                    <Text style={{ fontWeight: '800', color: 'green', textAlign: 'center', marginHorizontal: 50 }}> برای مشاهده این قسمت لطفا نسبت به فعالسازی  بخش تشخیص های افتراقی اقدام نمایید</Text>
                </View>
            )}
