...
const Editorf = (props) => {
    ...
    useEffect(() => {
        fetch('https://draydinv.ir/extra/gethtmlforedite.php', {
            ...
            body: JSON.stringify({
              fasl_name_en: props.fasl_name_en,
    ...
    const handlechangecontent = () => {
        ...
        fetch('https://draydinv.ir/extra/addcontent.php', {
            ...
            body: JSON.stringify({
                ...
                fasl_name_fa: props.fasl_name_fa,
                subject: props.subject,
                content: htmlContent,
    ...
    return (
        <ScrollView>
            ...
            <View style={{ flexDirection: 'row-reverse', justifyContent: 'center', alignSelf: 'center' }}>
                ...
                <Text style={{ marginVertical: 3, fontWeight: '600', color: '#06d6a0', verticalAlign: 'bottom', marginHorizontal: 3, justifyContent: 'center', alignSelf: 'center' }}>از فصل {props.fasl_name_fa} </Text>
            </View>
            <View style={{ marginBottom: 250, flex: 1, flexDirection: 'column', width: Dimensions.get('window').width * 4.75 / 5, justifyContent: 'center', alignSelf: 'center' }}>
                ...
                <TouchableOpacity title="ورود" onPress={handlechangecontent} style={{ marginTop: 10, width: width * 4.75 / 5, justifyContent: 'center', alignSelf: 'center', backgroundColor: '#06d6a0', height: height / 17, borderRadius: 10 }} >
