...
const Editorg = (props) => {
    ...
    useEffect(() => {
        fetch('https://draydinv.ir/extra/gethtmlforedite1.php', {
            method: 'POST',
            headers: {
    ...
    const handlechangeoscecontent = () => {



        fetch('https://draydinv.ir/extra/addoscecontent.php', {
            method: 'POST',
            headers: {
    ...
    return (
        <ScrollView>
            ...
            <View style={{ flexDirection: 'row-reverse', justifyContent: 'center', alignSelf: 'center' }}>
                ...
                <Text style={{ marginVertical: 3, fontWeight: '600', color: '#06d6a0', verticalAlign: 'bottom', marginHorizontal: 3, justifyContent: 'center', alignSelf: 'center' }}>از فصل {props.name_fa} </Text>
            </View>
            <View style={{ marginBottom: 250, flex: 1, flexDirection: 'column', width: Dimensions.get('window').width * 4.75 / 5, justifyContent: 'center', alignSelf: 'center' }}>
                ...
                <TouchableOpacity title="ورود" onPress={handlechangeoscecontent} style={{ marginTop: 10, width: width * 4.75 / 5, justifyContent: 'center', alignSelf: 'center', backgroundColor: '#06d6a0', height: height / 17, borderRadius: 10 }} >
