...
export default class Editoscefaslscreen extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            cat_en: this.props.route.params.cat_en,
            showtext: false,
            showtext1: false,
            showtext2: false,
            subject: '',
    ...
    render() {
        ...
        const ListItem = ({ text1, text2, text3, text4, onPress }) => (
            <TouchableOpacity style={styles.item} onPress={onPress} activeOpacity={0.9}>
                ...
                <View style={{ flexDirection: 'row-reverse' }}>
                    <TouchableOpacity onPress={() => navigation.navigate('Addoscecontent', { name_fa: text1, name_en: text2, subject: text3, subject1: text4 })} >
                        <Image source={require('../assets/image/edit.png')} style={{ marginLeft: 5 }} resizeMode='contain' />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('Changeoscecontent', { name_fa: text1, name_en: text2, subject: text3, subject1: text4 })} >
