...
import Editorf from './customeditor5';

export default class Changecontentscreen extends Component {
  ...
  render() {
    ...
    return (
      ...
      <View style={{backgroundColor:'white',flex:1,marginTop:50}}>
        ...
        <Editorf  subject={this.state.subject} fasl_name_fa={this.state.fasl_name_fa} fasl_name_en={this.state.fasl_name_en} subject1={this.state.subject1} />
