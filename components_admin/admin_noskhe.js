...
export default class Admin_noskhe extends Component {
    ...
    handlex = (x) => {
        if (x == 1) {
            ...
            this.setState({ cours: 'ضمائم' })
            this.setState({ cours1: 'append' })
            this.getMovies('append')
        } 
    }
    ...
    render() {
        ...
        const ListItem = ({name_fa, onPress ,name_en}) => (
            <TouchableOpacity style={styles.item} onPress={onPress} activeOpacity={0.9}>
                ...
                <View style={{ flexDirection: 'row-reverse' }}>
                    <TouchableOpacity onPress={()=>navigation.navigate('Add_contentnoskhe', { name_fa: name_fa,name_en:name_en,cours_en:this.state.cours1})} >
                        <Image source={require('../assets/image/edit.png')} style={{ marginLeft: 5 }} resizeMode='contain' />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>navigation.navigate('Changenoskhecontent', { name_fa: name_fa,name_en:name_en,cours_en:this.state.cours1})} >
        ...
        const Add = () => (
            <View style={{ justifyContent: 'space-around', alignItems: 'center', marginVertical: 15, flexDirection: 'row-reverse' }}>
                ...
                <TouchableOpacity title="ورود" onPress={()=>navigation.navigate('Add_noskhe1', { cours: this.state.cours ,cours1:this.state.cours1 })} style={{ width: width * 3.5 / 5, justifyContent: 'center', backgroundColor: '#06d6a0', borderRadius: 10, marginBottom: 10, elevation: 3, padding: 10 }} >

                    <Text style={{ textAlign: 'center', color: 'white', fontWeight: '900', }}>اضافه کردن نسخه جدید به {this.state.cours}</Text>
        ...
        return (
            ...
            <View style={{ marginTop: 10 }}>
                <Customswich_component9 sendxtoparent={this.handlex} selectionmode={3} onselectswitch={onselectswich} />
                                    ...
                                    : (
                                        <SafeAreaView >
                                            ...
                                            <View>
                                                <Add />
                                                <View style={{ flexDirection: 'row-reverse' }}>
                                                <Text style={{ marginVertical: 10, fontWeight: '900', color: '#D20062', verticalAlign: 'bottom', marginRight: 10 }}> لیست نسخه های</Text>
